...
|                               | KorQuAD1.0 (F1/EM) | ETRI law mrc (F1/EM) | KLUE NER(F1) | KMOU NER(F1) | KorNLI(acc) | Kor STS(spearman) | KLUE STS(pearson) | 계약서추천 TC(F1) | 개인정보NER(F1) | 계약서 mrc(F1) |
|:-----------------------------:|:------------------:|:--------------------:|:------------:|:------------:|:-----------:|:-----------:|:-----------:|:---------------------:|:-----------------------:|:-----------------------:|
|       BERT (Small Size)       |    87.97/77.78     |    87.62/73.55       |  89.18       |  89.69       |  73.0       |  80.22       |  77.80       |  76.6                 |  71.45                  |  86.29                  |
|       BERT (Base Size)        |    92.00/83.36     |    91.52/79.85       |  91.78       |  90.92       |  78.4       |  83.40       |  87.93       |  79.5                 |  72.79                  |  -                  |
...
| BERT (Base Size) + FastText + LSTM |    92.72/81.56       |    -       |
